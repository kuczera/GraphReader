...
In diesem Buch geht es nicht um Graphen im Sinne von Lösung von Gleichungen wie in Abb. \ref{graphnichtgraph} rechts. Es geht um Informationen, die durch Knoten und Kanten dargestellt werden, wie links im Bild.
...
Im Graphen in Abb. \ref{ungewichteter} werden Beziehungen zwischen Personen abgebildet. Über die Intensität der Beziehungen wird nichts gesagt. In  Abb. \ref{gewichteter} wurde den Beziehungen zwischen jeweils ein Wert zwischen 0 und 100 zugeordnet.
