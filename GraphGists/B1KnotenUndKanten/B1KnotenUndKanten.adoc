...
CAUTION: Übrigens: Da Kanten in Cypher immer eine Richtung haben, eine Ehe aber auf Gegenseitigkeit basiert, erstellen wir "VERHEIRATET_MIT"-Kanten doppelt, also in jede Richtung einmal. 
